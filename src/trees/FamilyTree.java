...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) {
			throw new TreeException("Inproper input format");//throw a TreeException with a useful message
		}
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException ("Parent node was not found"); //If the parent node wasn't found, there must have been something wrong in the 
			}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException ("No such name!");
		}
